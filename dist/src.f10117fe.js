...
var Model = /*#__PURE__*/function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; //? Even shorter syntax for creating a getter. First one will stay as an example;
  ...
  _createClass(Model, [{
    key: "on",
    get: function get() {
      return this.events.on; //? dont invoke function here!
...
function () {
  ...
  Attributes.prototype.set = function (update) {
    Object.assign(this.data, update); // copy data comes from update and override this.data (replace data)
  };
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function eventsMap() {
      return {}; //now eventsMap is not required for future implementations
    }
  }, {
    key: "bindModel",
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        var _eventKey$split = eventKey.split(":"),
            ...
            selector = _eventKey$split2[1]; // eventName = 'click' and selector = 'button' here
    ...
    key: "render",
    value: function render() {
      this.parent.innerHTML = ""; //? empty html before re-render
      ...
      this.onRender(); //* assign this element to child of 'parent' Element.
